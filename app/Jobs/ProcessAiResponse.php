...
class ProcessAiResponse implements ShouldQueue
{
    ...
    public function handle(AiService $aiService): void
    {
        ...
        // Inject visitor name into system prompt so AI can greet by name
        if ($conversation->visitor_name) {
            $systemPrompt .= "\n\nThe visitor's name is: {$conversation->visitor_name}";
        }
        ...
        try {
            ...
            // Let transient provider issues retry (429/5xx) instead of immediate fallback.
