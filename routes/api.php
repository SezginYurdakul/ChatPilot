...
Route::prefix('v1')->middleware(ValidateSiteKey::class)->group(function () {
    ...
    Route::prefix('conversations/{conversation}')
        ...
        ->group(function () {
            ...
            Route::post('heartbeat', [Widget\PresenceController::class, 'heartbeat']);
            Route::post('offline', [Widget\PresenceController::class, 'offline']);
        });
});
...
Route::prefix('v1')->middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::delete('conversations/{conversation}', [Admin\ConversationController::class, 'destroy']);
