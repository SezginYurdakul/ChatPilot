                                        ...
                                        <template x-for="conv in conversations" :key="conv.id">
                                            <div @click="selectConversation(conv.id)"
                                                ...
                                                <div class="flex items-center justify-between mb-1">
                                                    ...
                                                    <span class="text-xs text-gray-400" x-text="formatTime(conv.last_message_at || conv.updated_at)"></span>
                                                </div>
                                        ...
                                        <div class="flex flex-col h-full">
                                            ...
                                            <div data-messages class="flex-1 overflow-y-auto p-4 space-y-3">
                                                ...
                                                <template x-for="msg in messages" :key="msg.id">
                                                    <div class="flex" :class="msg.sender_type === 'admin' || msg.sender_type === 'ai' ? 'justify-end' : 'justify-start'">
